...
const Contact = () => {
    ...
    <section className="contact section" id="contact">
        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">manojkumarkumar01189@gmail.com</span>
                        
                        <a href="mailto:manojkumarkumar01189@gmail.com" className="contact__button">
                            Write Me{" "} 
            ...
            <div className="contact__content">
                <h3 className="contact__title">May I Know You</h3>
